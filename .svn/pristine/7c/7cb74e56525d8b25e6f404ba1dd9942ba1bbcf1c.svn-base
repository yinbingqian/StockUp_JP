...
public class PushSetActivity extends InstrumentedActivity implements OnClickListener {
	...
	public void onCreate(Bundle icicle) {
		...
		setContentView(R.layout.jp_push_set_dialog);
		init();
		initListener();
	}
	...
	private void setTag(){
		...
		if (TextUtils.isEmpty(tag)) {
			Toast.makeText(PushSetActivity.this,R.string.jp_error_tag_empty, Toast.LENGTH_SHORT).show();
			return;
		}
		...
		for (String sTagItme : sArray) {
			if (!ExampleUtil.isValidTagAndAlias(sTagItme)) {
				Toast.makeText(PushSetActivity.this,R.string.jp_error_tag_gs_empty, Toast.LENGTH_SHORT).show();
				return;
			}
			tagSet.add(sTagItme);
		}
	...
	private void setAlias(){
		...
		if (TextUtils.isEmpty(alias)) {
			Toast.makeText(PushSetActivity.this,R.string.jp_error_alias_empty, Toast.LENGTH_SHORT).show();
			return;
		}
	...
	private void setStyleCustom(){
		CustomPushNotificationBuilder builder = new CustomPushNotificationBuilder(PushSetActivity.this,R.layout.jp_customer_notitfication_layout,R.id.icon, R.id.title, R.id.text);
