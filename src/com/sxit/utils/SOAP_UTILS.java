...
public class SOAP_UTILS {
	public class METHOD {
		...
		// 返回最新新闻列表(无分类)
		public static final String GETNEWSTITLEV2 = "GetNewsTitleV2";
		...
		//根据分析师id查找分析师视频
		public static final String GETANALYSTVIDEO="GetAnalystVideo";
	}
...
//	public static final String IP = "http://guzhang.tvlicai.com/test";
...
//	public static final String HEADER_URL = "http://218.60.13.9:8002/upload/headpic/";
	...
	//http://guzhang.tvlicai.com/phoneinvoke.asmx?wsdl
