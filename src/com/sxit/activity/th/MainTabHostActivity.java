...
public class MainTabHostActivity extends TabHostAbstractActivity {
	...
	protected void prepare() {
		TabHostItem info = new TabHostItem(getString(R.string.tabHost_frist), // title
				...
				new Intent(this, Information_Activity.class)); // intent

		TabHostItem analyst = new TabHostItem(getString(R.string.tabHost_second), R.drawable.tab_icon_2_u, R.drawable.maintab_toolbar_bg, new Intent(this, Analyst_Activity.class));

		TabHostItem ask = new TabHostItem(getString(R.string.tabHost_thrid), R.drawable.tab_icon_3_u, R.drawable.maintab_toolbar_bg, new Intent(this, AskQuestion_Activity.class));

		TabHostItem myzone = new TabHostItem(getString(R.string.tabHost_fourth), R.drawable.tab_icon_4_u, R.drawable.maintab_toolbar_bg, new Intent(this, MyZone_Activity.class));
