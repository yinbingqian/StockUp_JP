...
//		if(list.get(position).get.getGroupid().equals("3")){
//			viewHolder.tv_title.setTextColor(context.getResources().getColor(R.color.red));
//			
//		}else{
//			textView.setTextColor(context.getResources().getColor(R.color.blcak));
//			
//			}
		System.out.println(list.get(position).getAdviser() == null ? ">>>>null" : ">>>>not null");
		if (list.get(position).getAdviser() != null) {
			if (list.get(position).getAdviser().getAdv_user_id().toString().trim().equals("1")) {
				viewHolder.tv_title.setText("股涨大讲堂");
			}
			System.out.println("### viewHolder.tv_title = " + viewHolder.tv_title.getText() + " and id = " + list.get(position).getAdviser().getAdv_user_id());
		}
		...
		viewHolder.tv_date.setText(Utils.getMsgDateString(list.get(position).getDate()));
		...
		if (list.get(position).getTime().equals("0")) {
			...
			// viewHolder.tv_time.setText(Utils.getMsgDateString(list.get(position).getTime()));
