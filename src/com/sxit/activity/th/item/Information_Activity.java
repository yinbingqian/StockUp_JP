...
//	private TextView tv_setting;// setting
	/** listView **/
...
System.out.println("@@@!!!!!!!>>"+list.get(position - 1).getAdviser().getHeartcount());
				i.putExtras(bundle);
			...
			case 1:
				...
				i.setClass(Information_Activity.this, NewsList_Activity.class);
				startActivity(i);
				break;
			case 2:
