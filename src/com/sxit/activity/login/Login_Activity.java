...
import com.sxit.activity.register.RetrievePassword_Activity;
...
public class Login_Activity extends BaseActivity {
	...
	private TextView tv_register, tv_password;
...
//			login_validate(actv_username.getText().toString().trim(), actv_password.getText().toString().trim());  //未加密
			break;
		...
		case R.id.tv_password:
			intent.setClass(Login_Activity.this, RetrievePassword_Activity.class);
			startActivity(intent);
			break;
