...
//						ib.setContent("语音消息");
					...
					// TODO
					if(adv_list.get(i).getGroupid().equals("16")){	
						ib.setNotifType(0);
					}else{						
						ib.setNotifType(2);
					}
...
//					} else if (adv_list.get(i).getAdv_user_id().toString().equals("1")) {
					} else if (adv_list.get(i).getGroupid().equals("16")||adv_list.get(i).getAdv_user_id().toString().equals("1")) {
						ib.setNotifType(0);
					} else {
						ib.setNotifType(2);
					}
