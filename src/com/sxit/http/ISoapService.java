...
public interface ISoapService extends IASoapService{
	 ...
	 * @param property_va
	 */
	void getBestAnswer(Object[] property_va);
	 ...
	 * @param property_va
	 */
	void opinion(Object[] property_va);/**
	 * 用户名反馈：返回true可用|false不可用
	 * 
	 * @param property_va
	 */
	...
	void SimVerify(Object[] property_va);
	...
	void getAnalystVideo(Object[] property_va);
	/**
	 * 根据分析师id查找分析师视频
	 * 
	 * @param property_va
	...
	void getNewsTitleV2(Object[] property_va,boolean isPage);
	/**
	 * 查看新闻列表
	 * 
	 * @param property_va
