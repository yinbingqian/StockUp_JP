...
public class PayDemoActivity2 extends FragmentActivity {
		...
		public void handleMessage(Message msg) {
			...
			case SDK_PAY_FLAG: {
				...
				if (TextUtils.equals(resultStatus, "9000")) {
					Toast.makeText(PayDemoActivity2.this, "支付成功", Toast.LENGTH_SHORT).show();
					...
					if (TextUtils.equals(resultStatus, "8000")) {
						Toast.makeText(PayDemoActivity2.this, "支付结果确认中", Toast.LENGTH_SHORT).show();
						PayDemoActivity2.this.finish();

					} else {
						Toast.makeText(PayDemoActivity2.this, "支付失败", Toast.LENGTH_SHORT).show();
						PayDemoActivity2.this.finish();
			...
			case SDK_CHECK_FLAG: {
				Toast.makeText(PayDemoActivity2.this, "检查结果为：" + msg.obj, Toast.LENGTH_SHORT).show();
				break;
			}
			default:
				break;
	...
	public void pay(View v) {
		...
		Runnable payRunnable = new Runnable() {
			...
			public void run() {
				// 构造PayTask 对象
				PayTask alipay = new PayTask(PayDemoActivity2.this);
				// 调用支付接口
	...
	public void check(View v) {
		Runnable checkRunnable = new Runnable() {
			...
			@Override
			public void run() {
				PayTask payTask = new PayTask(PayDemoActivity2.this);
